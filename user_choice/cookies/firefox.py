...
def get_mozilla_cookies(firefox_cookies_db):
    ...
    # Requête SQL pour récupérer les informations sur les cookies non de session
    query = """
        SELECT
            host,
            name
    ...
    # Afficher le graphe
    plt.title('Graphe des relations entre les sites via les cookies persistants de Firefox (cookies en triangle, sites en cercle)')
    plt.tight_layout()
    plt.show()
